...
(shared ((-3- (vector -4- -4- -4- -4- -4- -4- -4- -4- -4- -4-)) (-4- (make-block (make-color 30 30 30 255) #false))) (make-world-state BACKGROUND (vector -3- -3- -3- -3- -3- -3- -3- -3- -3- -3- -3- -3- -3- -3- -3- -3- -3- -3- -3- -3- -3- -3- -3- -3-) 100 #false #false #false (vector (make-posn 9 6) (make-posn 8 6) (make-posn 9 5) (make-posn 8 5)) #false 0 10 0 0 #false)))
